...
//
// MD5 hash CPU code using AVX-512 instructions (Intel/AMD)
//
...
#ifndef MD5_CPU_AVX512F
#define MD5_CPU_AVX512F
...
# define C(c)   (v16si){(int)(c), (int)(c), (int)(c), (int)(c), \
...
# define N_TIMING_TESTS  1000000u
  ...
  //
  // measure the execution time of mp5_cpu_avx512()
  //
