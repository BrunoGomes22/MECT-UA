...
H_FILES  += deti_coins_vault.h deti_coins_cpu_search.h deti_coins_cpu_avx_search.h deti_coins_cpu_avx2_search.h deti_coins_cpu_special_search.h
...
#
# compile for Intel/AMD processors without CUDA and with OpenMP
#
