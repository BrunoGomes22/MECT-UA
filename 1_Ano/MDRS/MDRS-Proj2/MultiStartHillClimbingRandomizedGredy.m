function [bestSol, bestObjective, noCycles, bestTime, bestCycle] = MultiStartHillClimbingRandomizedGredy(nNodes, Links, T, sP, nSP, timeLimit)
    ...
    while toc(t) < timeLimit
        ...
        [sol, load] = HillClimbing(nNodes, Links, T, sP, nSP, sol, load);
